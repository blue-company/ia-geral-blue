      ...
      <div className="w-full max-w-6xl mx-auto px-6">
        <SectionHeader>
          ...
          <p className="text-muted-foreground text-center text-balance font-medium">
            Thanus é totalmente de código aberto. Junte-se à nossa comunidade e ajude a moldar o futuro da IA.
          </p>
        </SectionHeader>
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="relative">
                ...
                <p className="text-muted-foreground mt-2">
                  Explore, contribua ou faça um fork do nosso repositório. Thanus é construído com transparência e colaboração em seu núcleo.
                </p>
              </div>
              ...
              <Link 
                href="https://github.com/Thanus-ai/Thanus"
                target="_blank" 
