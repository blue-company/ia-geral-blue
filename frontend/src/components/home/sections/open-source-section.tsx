      ...
      <div className="w-full max-w-6xl mx-auto px-6">
        <SectionHeader>
          ...
          <p className="text-muted-foreground text-center text-balance font-medium">
            Subzero is fully open source. Join our community and help shape the future of AI.
          </p>
        </SectionHeader>
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="relative">
                ...
                <p className="text-muted-foreground mt-2">
                  Explore, contribute, or fork our repository. Subzero is built with transparency and collaboration at its core.
                </p>
              </div>
              ...
              <Link 
                href="https://github.com/Kortix-ai/Subzero" 
                target="_blank" 
